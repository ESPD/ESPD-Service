...
For The ESPD XML Schema version in element cbc:VersionID, until now deployment date is used. It will be changed to correct ESPD XML Schema version.
...
<1> XML element VersionID contains the correct ESPD XML Schema version.

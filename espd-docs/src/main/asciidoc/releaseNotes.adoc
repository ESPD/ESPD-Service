...
* https://github.com/ESPD/ESPD-Service/issues/204
* https://github.com/ESPD/ESPD-Service/issues/215
* Added phase-out message to home page

=== 2018.10 (15th of October 2018)

* https://github.com/ESPD/ESPD-Service/issues/213[Missing translations]
* https://github.com/ESPD/ESPD-Service/issues/206[Part VI changing the value of createcafinish_concl_statements_text]

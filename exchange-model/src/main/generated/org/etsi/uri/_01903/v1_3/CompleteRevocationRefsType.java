    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "crlRefs", buffer, theCRLRefs);
        }
        {
            OCSPRefsType theOCSPRefs;
            theOCSPRefs = this.getOCSPRefs();
            strategy.appendField(locator, this, "ocspRefs", buffer, theOCSPRefs);
        }
        {
            OtherCertStatusRefsType theOtherRefs;
            theOtherRefs = this.getOtherRefs();
            strategy.appendField(locator, this, "otherRefs", buffer, theOtherRefs);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CompleteRevocationRefsType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CompleteRevocationRefsType that = ((CompleteRevocationRefsType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "crlRefs", lhsCRLRefs), LocatorUtils.property(thatLocator, "crlRefs", rhsCRLRefs), lhsCRLRefs, rhsCRLRefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ocspRefs", lhsOCSPRefs), LocatorUtils.property(thatLocator, "ocspRefs", rhsOCSPRefs), lhsOCSPRefs, rhsOCSPRefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "otherRefs", lhsOtherRefs), LocatorUtils.property(thatLocator, "otherRefs", rhsOtherRefs), lhsOtherRefs, rhsOtherRefs)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CRLRefsType theCRLRefs;
            theCRLRefs = this.getCRLRefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "crlRefs", theCRLRefs), currentHashCode, theCRLRefs);
        }
        {
            OCSPRefsType theOCSPRefs;
            theOCSPRefs = this.getOCSPRefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ocspRefs", theOCSPRefs), currentHashCode, theOCSPRefs);
        }
        {
            OtherCertStatusRefsType theOtherRefs;
            theOtherRefs = this.getOtherRefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "otherRefs", theOtherRefs), currentHashCode, theOtherRefs);
        }
        {
            String theId;
            theId = this.getId();

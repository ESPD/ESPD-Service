    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "sigPolicyQualifier", buffer, theSigPolicyQualifier);
        }
        return buffer;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SigPolicyQualifiersListType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final SigPolicyQualifiersListType that = ((SigPolicyQualifiersListType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "sigPolicyQualifier", lhsSigPolicyQualifier), LocatorUtils.property(thatLocator, "sigPolicyQualifier", rhsSigPolicyQualifier), lhsSigPolicyQualifier, rhsSigPolicyQualifier)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<AnyType> theSigPolicyQualifier;
            theSigPolicyQualifier = (((this.sigPolicyQualifier!= null)&&(!this.sigPolicyQualifier.isEmpty()))?this.getSigPolicyQualifier():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "sigPolicyQualifier", theSigPolicyQualifier), currentHashCode, theSigPolicyQualifier);
        }

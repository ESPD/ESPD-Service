    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "crlRef", buffer, theCRLRef);
        }
        return buffer;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CRLRefsType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CRLRefsType that = ((CRLRefsType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "crlRef", lhsCRLRef), LocatorUtils.property(thatLocator, "crlRef", rhsCRLRef), lhsCRLRef, rhsCRLRef)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<CRLRefType> theCRLRef;
            theCRLRef = (((this.crlRef!= null)&&(!this.crlRef.isEmpty()))?this.getCRLRef():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "crlRef", theCRLRef), currentHashCode, theCRLRef);
        }

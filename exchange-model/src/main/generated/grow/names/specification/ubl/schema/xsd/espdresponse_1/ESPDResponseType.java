...
/**
 * <p>Java class for ESPDResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ESPDResponseType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{urn:grow:names:specification:ubl:schema:xsd:ESPD-CommonBasicComponents-1}EconomicOperatorGroupName" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:grow:names:specification:ubl:schema:xsd:ESPD-CommonAggregateComponents-1}EconomicOperatorParty"/&gt;
...
@XmlType(name = "ESPDResponseType", propOrder = {
    "ublExtensions",
    "ublVersionID",
    "customizationID",
    "profileID",
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "EconomicOperatorGroupName", namespace = "urn:grow:names:specification:ubl:schema:xsd:ESPD-CommonBasicComponents-1")
    protected NameType economicOperatorGroupName;
    ...
    @XmlElement(name = "EconomicOperatorParty", namespace = "urn:grow:names:specification:ubl:schema:xsd:ESPD-CommonAggregateComponents-1", required = true)
    ...
    /**
     * Gets the value of the economicOperatorGroupName property.
     * 
     * @return
     *     possible object is
     *     {@link NameType }
     *     
     */
    public NameType getEconomicOperatorGroupName() {
     ...
     *     
     */
    public void setEconomicOperatorGroupName(NameType value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            NameType theEconomicOperatorGroupName;
            theEconomicOperatorGroupName = this.getEconomicOperatorGroupName();
            strategy.appendField(locator, this, "economicOperatorGroupName", buffer, theEconomicOperatorGroupName);
        }
        {
        ...
        {
            EconomicOperatorPartyType theEconomicOperatorParty;
            theEconomicOperatorParty = this.getEconomicOperatorParty();
            strategy.appendField(locator, this, "economicOperatorParty", buffer, theEconomicOperatorParty);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ESPDResponseType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ESPDResponseType that = ((ESPDResponseType) object);
        {
        ...
        {
            NameType lhsEconomicOperatorGroupName;
            lhsEconomicOperatorGroupName = this.getEconomicOperatorGroupName();
            NameType rhsEconomicOperatorGroupName;
            rhsEconomicOperatorGroupName = that.getEconomicOperatorGroupName();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "economicOperatorGroupName", lhsEconomicOperatorGroupName), LocatorUtils.property(thatLocator, "economicOperatorGroupName", rhsEconomicOperatorGroupName), lhsEconomicOperatorGroupName, rhsEconomicOperatorGroupName)) {
                return false;
            }
        }
        {
        ...
        {
            EconomicOperatorPartyType lhsEconomicOperatorParty;
            lhsEconomicOperatorParty = this.getEconomicOperatorParty();
            EconomicOperatorPartyType rhsEconomicOperatorParty;
            rhsEconomicOperatorParty = that.getEconomicOperatorParty();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "economicOperatorParty", lhsEconomicOperatorParty), LocatorUtils.property(thatLocator, "economicOperatorParty", rhsEconomicOperatorParty), lhsEconomicOperatorParty, rhsEconomicOperatorParty)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            NameType theEconomicOperatorGroupName;
            theEconomicOperatorGroupName = this.getEconomicOperatorGroupName();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "economicOperatorGroupName", theEconomicOperatorGroupName), currentHashCode, theEconomicOperatorGroupName);
        }
        {
            ContractingPartyType theContractingParty;
            theContractingParty = this.getContractingParty();
        ...
        }
        {
            EconomicOperatorPartyType theEconomicOperatorParty;
            theEconomicOperatorParty = this.getEconomicOperatorParty();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "economicOperatorParty", theEconomicOperatorParty), currentHashCode, theEconomicOperatorParty);
        }
        {
            List<ProcurementProjectLotType> theProcurementProjectLot;
            theProcurementProjectLot = (((this.procurementProjectLot!= null)&&(!this.procurementProjectLot.isEmpty()))?this.getProcurementProjectLot():null);

    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "identificationCode", buffer, theIdentificationCode);
        }
        {
            NameType theName;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CountryType)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            IdentificationCodeType theIdentificationCode;
            theIdentificationCode = this.getIdentificationCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "identificationCode", theIdentificationCode), currentHashCode, theIdentificationCode);
        }
        {
            NameType theName;
            theName = this.getName();

...
import static eu.europa.ec.grow.espd.criteria.enums.EconomicOperatorCriterionGroup.*;
 ...
 */
@Getter
public enum EconomicOperatorCriterion implements CcvCriterion {
    ...
    private final EconomicOperatorTypeCode criterionTypeCode;

    private final LegislationReference legislationReference;

    private final List<? extends CcvCriterionGroup> groups;

    EconomicOperatorCriterion(String uuid, String shortName, String description,
            EconomicOperatorTypeCode criterionTypeCode, LegislationReference legislationReference,

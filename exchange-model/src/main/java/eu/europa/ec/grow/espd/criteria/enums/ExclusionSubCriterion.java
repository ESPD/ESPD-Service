...
public enum ExclusionSubCriterion implements CcvCriterion {
    ...
    PARTICIPATION_CRIMINAL_ORGANISATION_GROUP("7c637c0c-7703-4389-ba52-02997a055bd7", list(SELF_CLEANING_GROUP),
            list(DATE_OF_CONVICTION, REASON, WHO_CONVICTED, LENGTH_PERIOD_EXCLUSION)),
    /**
     *
     */
    ...
    BANKRUPTCY_GROUP("d91c11a1-f19e-4b83-8ade-c4be2bf00555", Collections.<CcvCriterion>emptyList(),
            list(PLEASE_DESCRIBE, REASONS_NEVERTHELESS_CONTRACT)),
    /**
     *
     */
    ...
    CONFLICT_OF_INTEREST_EO_PROCUREMENT_PROCEDURE_GROUP("30450436-f559-4dfa-98ba-f0842ed9d2a0",
            list(SELF_CLEANING_GROUP), list(PLEASE_DESCRIBE)),
    /**
     *
     */

 ...
 */
@Getter
public enum SelectionSubCriterion implements CcvCriterion {

    /**
     *
     */
    INFO_ELECTRONICALLY_GROUP("9026e403-3eb6-4705-a9e9-e21a1efc867d", Collections.<CcvCriterion>emptyList(),
            list(INFO_AVAILABLE_ELECTRONICALLY, URL, URL_CODE)),
    /**
     *
     */
    ALL_CRITERIA_SATISFIED_GROUP("f3a6836d-2de2-4cd1-81ca-fb06178d05c5", Collections.<CcvCriterion>emptyList(),
            list(ANSWER_YES_NO)),
    /**
     *
     */
    ENROLLMENT_PROFESSIONAL_REGISTER_GROUP("1768de86-a6c8-48e4-bd8e-de2f2f7424d0",
            Collections.<CcvCriterion>emptyList(), list(ANSWER_YES_NO)),
    /**
     *
     */
    ENROLLMENT_TRADE_REGISTER_GROUP("8fe21e2c-5490-474b-90e6-fe25a7d8c538", Collections.<CcvCriterion>emptyList(),
            list(ANSWER_YES_NO)),
    /**
     *
     */
     ...
     *
     */
    GENERAL_YEARLY_TURNOVER_GROUP("e1886054-ada4-473c-9afc-2fde82c24cf4", Collections.<CcvCriterion>emptyList(),
            list(YEAR_AMOUNT_CURRENCY)),
    /**
     *
     */
    AVERAGE_YEARLY_TURNOVER_GROUP("08da0667-c7e3-445f-a548-1107794ef7d5", Collections.<CcvCriterion>emptyList(),
            list(YEAR_AMOUNT_CURRENCY)),
    /**
     *
     */
    SPECIFIC_YEARLY_TURNOVER_GROUP("ee1fdbab-f54e-4579-bcb8-060fe45178e9", Collections.<CcvCriterion>emptyList(),
            list(YEAR_AMOUNT_CURRENCY)),
    /**
     *
     */
    SPECIFIC_AVERAGE_TURNOVER_GROUP("fa29f9e1-dd24-4fe9-873d-1a6dbc720cb0", Collections.<CcvCriterion>emptyList(),
            list(YEAR_AMOUNT_CURRENCY)),
    /**
     *
     */
    FINANCIAL_RATIO_GROUP("cf00f7bb-c2cf-4565-91bb-221d78d8dd2f", Collections.<CcvCriterion>emptyList(),
            list(REQUIRED_RATIO)),
    /**
     *
     */
    PROFESSIONAL_RISK_INSURANCE_GROUP("42dc8062-974d-4201-91ba-7f2ea90338fd",
            Collections.<CcvCriterion>emptyList(), list(AMOUNT_CURRENCY)),
    /**
     *
     */
    OTHER_ECONOMIC_OR_FINANCIAL_REQUIREMENTS_GROUP("488ca189-bcdb-4bf4-80c7-3ad507fd89fb",
            Collections.<CcvCriterion>emptyList(), list(PLEASE_DESCRIBE)),
    /**
     *
     */
    WORK_CONTRACTS_PERFORMANCE_OF_WORKS_GROUP("996e24f2-fc7b-49a3-8b97-37268516a57c",
            Collections.<CcvCriterion>emptyList(), list(DESCRIPTION, AMOUNT, DATE, RECIPIENTS)),
    /**
     *
     */
    ...
    TECHNICIANS_OR_TECHNICAL_BODIES_GROUP("9e2fd892-80e2-4c13-98bb-1515e56f45af",
            Collections.<CcvCriterion>emptyList(), list(PLEASE_SPECIFY)),
    /**
     *
     */
     ...
     *
     */
    SUPPLY_CHAIN_MANAGEMENT_GROUP("2fd60f39-d484-4862-ba5f-0a8c46da11d8", Collections.<CcvCriterion>emptyList(),
            list(PLEASE_DESCRIBE)),
    /**
     *
     */
    ALLOWANCE_OF_CHECKS_GROUP("d7721546-9106-43a7-8d31-2fe08a862b00", Collections.<CcvCriterion>emptyList(),
            list(PLEASE_DESCRIBE)),
    /**
     *
     */
    EDUCATIONAL_AND_PROFESSIONAL_QUALIFICATIONS_GROUP("094618e3-b243-49ce-9b12-6aab357f2f88",
            Collections.<CcvCriterion>emptyList(), list(PLEASE_ENUMERATE)),
    /**
     *
     */
    ...
    SUBCONTRACTING_PROPORTION_GROUP("575f7550-8a2d-4bad-b9d8-be07ab570076",
            Collections.<CcvCriterion>emptyList(), list(PERCENTAGE)),
    /**
     *
     */
    ...
    SelectionSubCriterion(String uuid, List<? extends CcvCriterion> subCriteria,

 ...
 */
@Getter
public enum AwardCriterionRequirement implements CcvCriterionRequirement {
    ...
    AwardCriterionRequirement(String id, String description, ExpectedResponseType responseType,

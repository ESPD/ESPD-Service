        ...
        <div class="panel panel-default no-border">
            <ul class="nav nav-pills nav-wizard nav-justified">
                ...
                <li class="${(procedure||exclusion||selection||finish)?'active':''}">
                    <div class="nav-wedge"></div> <a href="#"><i class="fa fa-university"></i>&nbsp;${span18n['progress_procedure']}</a> <div class="nav-arrow"></div>
                </li>
                <li class="${(exclusion||selection||finish)?'active':''}">
                    <div class="nav-wedge"></div> <a href="#"><i class="fa fa-exclamation"></i>&nbsp;${span18n['progress_exclusion']}</a> <div class="nav-arrow"></div>
                </li>
                <li class="${(finish||selection)?'active':''}">
                    <div class="nav-wedge"></div> <a href="#"><i class="fa fa-check-circle"></i>&nbsp;${span18n['progress_selection']}</a> <div class="nav-arrow"></div>
                </li>
                <li class="${finish?'active':''}">
                    <div class="nav-wedge"></div> <a href="#"><i class="fa fa-download"></i>&nbsp;${span18n['progress_finish']} </a>
				</li>
            </ul>
        </div>
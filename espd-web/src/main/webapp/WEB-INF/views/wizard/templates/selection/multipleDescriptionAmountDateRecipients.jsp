...
<div class="form-group hidden-xs hidden-print">
...
<c:forEach begin="1" end="5" varStatus="loop">
	<div class="form-group form-group-sm hidden-print" style="margin-bottom: 0px;">
	...
	<div class="visible-print">
			...
			<div class="form-group" style="padding:2px">
				<div class="col-xs-3">
			    	<label class="control-label small">${span18n['crit_date']}</label>
			    </div>
			    <div class="col-xs-9">
			    <form:input path="${field}.date${loop.index}" cssClass="form-control datepicker" cssStyle="border-radius: 0;" placeholder="${i18n['crit_date_placeholder']}"/>
			    </div>

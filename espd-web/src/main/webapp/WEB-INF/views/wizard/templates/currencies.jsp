...
<tiles:importAttribute name="currencyHtmlId"/>
<tiles:importAttribute name="currencyCssClass"/>

<form:select path="${currencyField}" id="${currencyHtmlId}" cssClass="${currencyCssClass}">

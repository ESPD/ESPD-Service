...
public enum Language {
    ...
    private static final int MAX_LANG_SIZE = 25;
     ...
     * @return
     *
     * @throws IllegalArgumentException If the language code is not recognized
     */
    public static Language getByLanguageCode(final String code) {
        ...
        checkArgument(found != null, "Language with code '%s' is not recognized by the application.", code);
        return found;
    }

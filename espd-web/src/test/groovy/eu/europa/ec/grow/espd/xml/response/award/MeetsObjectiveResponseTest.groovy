...
class MeetsObjectiveResponseTest extends AbstractAwardCriteriaFixture {
    ...
    def "05. should contain the 'If applicable, is the economic operator registered' criterion"() {
        ...
        def idx = getCriterionIndex(eu.europa.ec.grow.espd.criteria.enums.AwardCriterion.MEETS_OBJECTIVE)
    ...
    def "check the 'Info electronically URL' requirement response"() {
        ...
        def req = subGroup.Requirement[1]
        req.Response.size() == 1
        req.Response[0].Evidence.EvidenceDocumentReference.Attachment.ExternalReference.URI.text() == "http://hodor_07.com"
    }

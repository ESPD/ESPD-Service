...
class AverageAnnualManpowerResponseTest extends AbstractSelectionCriteriaFixture {
    ...
    def "26. should contain the 'Average annual manpower' criterion"() {
        ...
        checkCriterionId(response, idx, "1f49b3f0-d50f-43f6-8b30-4bafab108b9b")

        then: "CriterionTypeCode element"
        checkCriterionTypeCode(response, idx, "CRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.MANAGEMENT.AVERAGE_ANNUAL_MANPOWER")

        then: "CriterionName element"
        response.Criterion[idx].Name.text() == "Average annual manpower"

        then: "CriterionDescription element"
        response.Criterion[idx].Description.text() == "The economic operator’s average annual manpower for the last three years were as follows:"

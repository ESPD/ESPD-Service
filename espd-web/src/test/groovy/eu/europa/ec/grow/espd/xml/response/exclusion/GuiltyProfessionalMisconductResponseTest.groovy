...
class GuiltyProfessionalMisconductResponseTest extends AbstractExclusionCriteriaFixture {
    ...
    def "18. should contain the 'Guilty of grave professional misconduct' criterion"() {
        ...
        response.Criterion[idx].Description.text() == "Is the economic operator  guilty of grave professional misconduct? Where applicable, see definitions in national law, the relevant notice or the procurement documents."

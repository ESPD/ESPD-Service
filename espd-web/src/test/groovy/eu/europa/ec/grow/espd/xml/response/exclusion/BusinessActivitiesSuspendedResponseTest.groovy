...
class BusinessActivitiesSuspendedResponseTest extends AbstractExclusionCriteriaFixture {
    ...
    def "17. should contain the 'Business activities are suspended' criterion"() {
        ...
        response.Criterion[idx].Description.text() == "Are the business activities of the economic operator suspended?  This information needs not be given if exclusion of economic operators in this case has been made mandatory under the applicable national law without any possibility of derogation where the economic operator is nevertheless able to perform the contract."
    ...
    def "check the 'Your answer' requirement response"() {
        given:
        def espd = new EspdDocument(businessActivitiesSuspended: new BankruptcyCriterion(exists: true, answer: false))

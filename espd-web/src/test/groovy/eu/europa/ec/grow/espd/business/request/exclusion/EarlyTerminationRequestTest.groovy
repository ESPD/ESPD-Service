...
class EarlyTerminationRequestTest extends AbstractRequestExclusionFixture {
    ...
    def "19. should contain the 'Early termination, damages or other comparable sanctions' criterion"() {
        ...
        then: "main sub group"
        request.Criterion[idx].SubCriterion[0].ID.text() == "72f29e01-d0be-4e33-90f3-954c26fd0899"
        request.Criterion[idx].SubCriterion[0].SubCriterion.size() == 1
        request.Criterion[idx].SubCriterion[0].Requirement.size() == 1

        then: "main sub group requirements"
        def r1_2 = request.Criterion[idx].SubCriterion[0].Requirement[0]
        checkRequirement(r1_2, "7b07904f-e080-401a-a3a1-9a3efeeda54b", "Please describe them", "DESCRIPTION")

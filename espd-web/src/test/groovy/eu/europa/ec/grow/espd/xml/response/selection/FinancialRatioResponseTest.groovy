...
class FinancialRatioResponseTest extends AbstractSelectionCriteriaFixture {
    ...
    def "check the 'Description' requirements response"() {
        ...
        def espd = new EspdDocument(financialRatio: new EconomicFinancialStandingCriterion(exists: true,
                unboundedGroups: [
                        new DynamicRequirementGroup("description": "d1"),
                        new DynamicRequirementGroup("description": "d2"),
                        new DynamicRequirementGroup("description": "d3"),
                        new DynamicRequirementGroup("description": "d4"),
                        new DynamicRequirementGroup("description": "d5")
                ]))
        ...
        then: "Description 2"
        def g2 = response.Criterion[idx].RequirementGroup[1]
        def req2 = g2.Requirement[0]
        req2.Response.size() == 1
        req2.Response[0].Description.text() == "d2"

        then: "Description 3"
        def g3 = response.Criterion[idx].RequirementGroup[2]
        def req3 = g3.Requirement[0]
        req3.Response.size() == 1
        req3.Response[0].Description.text() == "d3"

        then: "Description 4"
        def g4 = response.Criterion[idx].RequirementGroup[3]
        def req4 = g4.Requirement[0]
        req4.Response.size() == 1
        req4.Response[0].Description.text() == "d4"

        then: "Description 5"
        def g5 = response.Criterion[idx].RequirementGroup[4]
        def req5 = g5.Requirement[0]
    ...
    def "check the 'Ratio' requirements response"() {
        ...
        def espd = new EspdDocument(financialRatio: new EconomicFinancialStandingCriterion(exists: true,
                unboundedGroups: [
                        new DynamicRequirementGroup("ratio": 11.1),
                        new DynamicRequirementGroup("ratio": 22.2),
                        new DynamicRequirementGroup("ratio": 33.3),
                        new DynamicRequirementGroup("ratio": 44.4),

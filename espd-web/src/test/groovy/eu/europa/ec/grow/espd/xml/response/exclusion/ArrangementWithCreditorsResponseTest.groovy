...
class ArrangementWithCreditorsResponseTest extends AbstractExclusionCriteriaFixture {
    ...
    def "14. should contain the 'Arrangement with creditors' criterion"() {
        ...
        checkCriterionId(response, idx, "68918c7a-f5bc-4a1a-a62f-ad8983600d48")

        then: "CriterionTypeCode element"
        checkCriterionTypeCode(response, idx, "CRITERION.EXCLUSION.BUSINESS.CREDITORS_ARRANGEMENT")

        then: "CriterionName element"
        response.Criterion[idx].Name.text() == "Arrangement with creditors"

        then: "CriterionDescription element"
        response.Criterion[idx].Description.text() == "Is the economic operator in arrangement with creditors? This information needs not be given if exclusion of economic operators in this case has been made mandatory under the applicable national law without any possibility of derogation where the economic operator is nevertheless able to perform the contract."

...
class AverageAnnualManpowerRequestTest extends AbstractEspdXmlMarshalling {
    ...
    def "25. should contain the 'Average annual manpower' criterion"() {
        ...
        request.Criterion[idx].CriterionName.text() == "Average annual manpower"

        then: "CriterionDescription element"
        request.Criterion[idx].CriterionDescription.text() == "The economic operator’s average annual manpower for the last three years were as follows."

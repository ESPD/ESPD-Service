...
<div class="container espd-container">
	...
	<div class="panel-default">
		...
		<div class="paragraph">
			<h2 class="label_createca_header"><s:message code="createca_header"/></h2>
		</div>
		...
		<div class="errorContainer alert alert-danger" style="display: none">
			...
			<li>
				...
				<div class="label_createca_correct_errors"><s:message code="createca_correct_errors"/></div>
		...
		<div class="espd-panel panel panel-default">
			<div class="espd-panel-heading" data-toggle="collapse" data-target="#cadiv">
				<span class="label_createca_contact_details_ca"><s:message code="createca_contact_details_ca"/></span>
			</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_name"><s:message code="createca_name"/></span></label>
							<div class="col-md-8">
								<form:input cssClass="form-control" path="name" placeholder="Enter name" required="true"/>
							</div>
						</div>
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_nat_regnum"/><s:message code="createca_nat_regnum"/></span></label>
							<div class="col-md-8">
								<form:input cssClass="form-control" path="streetAndNumber" placeholder="Enter registration number"/>
							</div>
						</div>
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_street_and_num"/><s:message code="createca_street_and_num"/></span></label>
							<div class="col-md-8">
								<form:input cssClass="form-control" path="natRegNumber" placeholder="Enter street and number"/>
							</div>
						</div>
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_postcode"/><s:message code="createca_postcode"/></span></label>
							<div class="col-md-8">
								<form:input cssClass="form-control" path="postcode" placeholder="Enter Postcode"/>
							</div>
						</div>
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_city"/><s:message code="createca_city"/></span></label>
							<div class="col-md-8">
								<form:input cssClass="form-control" path="city" placeholder="Enter City"/>
							</div>
						</div>
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_country"/><s:message code="createca_country"/></span></label>
							<div class="col-md-8">
					...
					<div class="col-md-6">
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_contact_person"/><s:message code="createca_contact_person"/></span></label>
							<div class="col-md-8">
								<form:input cssClass="form-control" path="contactPerson" placeholder="Enter contact person"/>
							</div>
						</div>
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_email"/><s:message code="createca_email"/></span></label>
							<div class="col-md-8">
								<form:input cssClass="form-control" path="email" placeholder="Enter E-mail"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_confirm_email"/><s:message code="createca_confirm_email"/></span></label>
							<div class="col-md-8">
								<input class="form-control" placeholder="Confirm E-mail">
							</div>
						</div>
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_telephone"/><s:message code="createca_telephone"/></span></label>
							<div class="col-md-8">
								<form:input cssClass="form-control" path="telephone" placeholder="Enter Telephone"/>
							</div>
						</div>
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_confirm_telephone"/><s:message code="createca_confirm_telephone"/></span></label>
							<div class="col-md-8">
								<input type="name" class="form-control" placeholder="Confirm Telephone">
							</div>
						</div>
						<div class="form-group ">
							<label class="control-label col-md-4 " for="name"><span class="label_createca_website"/><s:message code="createca_website"/></span></label>
							<div class="col-md-8">
		...
		<div class="espd-panel panel panel-default">
			...
			<span class="label_createca_info_procurement_proc"><s:message code="createca_info_procurement_proc"/></span></span>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="alert alert-espd-info" style="border: 1px dotted blue; background-color: #D8D8D8;">
							<span class="label_createca_to_be_filled_alert"><s:message code="createca_to_be_filled_alert"/></span>
						</div>
					
						<div class="form-group col-md-12">
							<label class="control-label " for="pwd"><span class="label_createca_title_or_short_desc_"/><s:message code="createca_title_or_short_desc_"/></span></label>
							<form:textarea path="procedureDesc" cssStyle="resize: none" rows="4" cols="20" cssClass="form-control"/>
						</div>
		
						<div class="form-group col-md-12">
							<label class="control-label col-md-8 " for="name"><span class="label_createca_lots_concerned"/><s:message code="createca_lots_concerned"/></span></label>
							<div class="col-md-4">
								<form:input cssClass="form-control" path="lotConcerned" placeholder=""/>
							</div>
						</div>
						<div class="form-group col-md-12">
							<label class="control-label col-md-8 " for="name"><span class="label_createca_file_ref_ca"/><s:message code="createca_file_ref_ca"/></span></label>
							<div class="col-md-4">
								<form:input cssClass="form-control" path="fileRefByCA" placeholder=""/>
							</div>
						</div>
						<div class="form-group col-md-12">
							<label class="control-label col-md-8 " for="name"><span class="label_createca_website_proc_doc"/><s:message code="createca_website_proc_doc"/></span></label>
							<div class="col-md-4">

...
<div class="container espd-container">
	...
	<div class="panel-default">
		...
		<div class="col-md-5">
			<div class="btn-group">
				<a class="btn btn-default btn-lg" href="${pageContext.request.contextPath}/createcaexcl">
				...
				<a class="btn btn-default btn-lg" href="${pageContext.request.contextPath}/createcafinish">
